					...
					<div class="col-xs-6">
						...
						<div class="form-group">
							...
							<div class="col-md-5" style="margin-bottom : 2px;">
								...
								<input type="text" class="form-control"
									id="impactMdl" readonly/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">Type de presse :</label>
							<div class="col-md-5" style="margin-bottom : 2px;">

								<input type="text" class="form-control"
									id="typepresseMdl" readonly/>
							</div>
						</div>
