...
/**
 * The persistent class for the data_result database table.
 * 
 */
@Entity
...
public class DataResult implements Serializable {
	...
	public DataResult(int id, String categorie, String description,
	...
	public DataResult(String categorie, String description, String indexation,
	...
	public String toString() {
		return "DataResult [id=" + id + ", categorie=" + categorie
				+ ", description=" + description + ", indexation=" + indexation
				+ ", marque=" + marque + ", nomProduit=" + nomProduit
				+ ", prix=" + prix + ", prixnonreduis=" + prixnonreduis
				+ ", sousCategorie=" + sousCategorie + ", url=" + url + "]";
	}
